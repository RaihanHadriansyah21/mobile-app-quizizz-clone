...
class _DosenProfileScreenState extends State<DosenProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Profil Dosen', style: TextStyle(fontWeight: FontWeight.bold)),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: const InputDecoration(labelText: 'NIP / NIDN', hintText: 'Min. 7 digit angka'),
                        keyboardType: TextInputType.number,
                        validator: (value) {
                          if (value == null || value.trim().isEmpty) return 'NIP/NIDN tidak boleh kosong';
                          if (!RegExp(r'^\d+$').hasMatch(value)) return 'NIP/NIDN harus berupa angka';
                          if (value.trim().length < 7) return 'NIP/NIDN minimal 7 digit';
                          return null;
                        },
                      ),
                      const SizedBox(height: 16),
